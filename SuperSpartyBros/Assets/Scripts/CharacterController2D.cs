...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		{
            DoJump();
		} else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // if double jump true and jump key is press, and double jump
        {
            DoJump();
            _canDoubleJump = false; // disable double jump after double jomping 
        }
